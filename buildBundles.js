...
const BASE_BUNDLE = 'android/app/src/main/assets/index.android-base.bundle';
const ADDITIONAL_BUNDLE = 'android/app/src/main/assets/additional.bundle';
...
function removeBaseCode(outputPath, base = BASE_BUNDLE) {
    return new Promise(async (resolve, reject) => {
        ...
        let newPath = outputPath.substr(0, lastSlashIndex) + '/' + `chunk-${modId}-base.bundle`;
...
buildBaseBundle()
    .then(() => buildBundle({ entry: 'bundle/additional-entry.js', output: ADDITIONAL_BUNDLE }))
